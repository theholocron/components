import { location, type IGeolocationCoordinates } from "@theholocron/utils-location";
...
export function Provider(props: WithChildren) {
    ...
    const [userLocation, setUserLocation] = React.useState<IGeolocationCoordinates | null>(null);
    ...
    React.useEffect(() => {
        ...
        const fetchLocation = async () => {
            const cachedData = storage.getFrom(storageKey);
    ...
    const value = React.useMemo(() => ({ location: userLocation, isLoading }), [userLocation, isLoading]);
